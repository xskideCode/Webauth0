            ...
            <div class="card card-user">
                <div class="card-body">
                    ...
                    <div class="card-description">
                        {{ __('Embrace the truth fearlessly, for it is the cornerstone on which we must rebuild our human foundation. As a young learner pursuing a journey in Information Technology, standing alongside my co-founders at Muse...') }}
                    </div>
                </div>
                <div class="card-footer">
