                                    ...
                                    <ul class="nav">
                                        ...
                                        <li>
                                            <a data-toggle="collapse" href="#laravel-examples" aria-expanded="true">
                                                ...
                                                <span class="nav-link-text" >{{ __('Account Settings') }}</span>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow dropdown-black">
...
<div class="container-fluid">
    ...
    <div class="copyright">
        ...
        <a href="https://creative-tim.com" target="_blank">Jane</a> 
        <!-- 
        &amp;    
